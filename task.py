...
# import time
#
# schedule.every().monday.at("3:00").do(crawler_1)
# schedule.every().tuesday.at("3:00").do(crawler_2)
# schedule.every().wednesday.at("3:0").do(crawler_3)
# schedule.every().thursday.at("3:00").do(crawler_1)
# schedule.every().friday.at("3:00").do(crawler_2)
# schedule.every().saturday.at("3:0").do(crawler_3)
#
# while True:
